...
public final class PlantelPlantDao_Impl implements PlantelPlantDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfUpdateLastWatered;

  private final SharedSQLiteStatement __preparedStmtOfDeleteAllUserPlants;
  ...
  public PlantelPlantDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfPlantelPlantEntity = new EntityInsertionAdapter<PlantelPlantEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `plantel_plants` (`id`,`userId`,`productId`,`plantName`,`plantDescription`,`plantImageUrl`,`addedAt`,`lastWateredDate`,`wateringFrequencyDays`,`notes`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(4, entity.getPlantName());
        statement.bindString(5, entity.getPlantDescription());
        statement.bindString(6, entity.getPlantImageUrl());
        statement.bindLong(7, entity.getAddedAt());
        if (entity.getLastWateredDate() == null) {
          statement.bindNull(8);
        } else {
          statement.bindLong(8, entity.getLastWateredDate());
        }
        statement.bindLong(9, entity.getWateringFrequencyDays());
    ...
    this.__updateAdapterOfPlantelPlantEntity = new EntityDeletionOrUpdateAdapter<PlantelPlantEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `plantel_plants` SET `id` = ?,`userId` = ?,`productId` = ?,`plantName` = ?,`plantDescription` = ?,`plantImageUrl` = ?,`addedAt` = ?,`lastWateredDate` = ?,`wateringFrequencyDays` = ?,`notes` = ? WHERE `id` = ?";
      }
    ...
    this.__preparedStmtOfUpdateLastWatered = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE plantel_plants SET lastWateredDate = ? WHERE id = ?";
        return _query;
      }
    };
    this.__preparedStmtOfDeleteAllUserPlants = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
  ...
  @Override
  public Object updateLastWatered(final int plantId, final long date,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfUpdateLastWatered.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __preparedStmtOfUpdateLastWatered.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  @Override
  public Object deleteAllUserPlants(final int userId,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfDeleteAllUserPlants.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __preparedStmtOfDeleteAllUserPlants.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  public Flow<List<PlantelPlantEntity>> getUserPlants(final int userId) {
    final String _sql = "SELECT * FROM plantel_plants WHERE userId = ? ORDER BY addedAt DESC";
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"plantel_plants"}, new Callable<List<PlantelPlantEntity>>() {
      ...
      public List<PlantelPlantEntity> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfPlantDescription = CursorUtil.getColumnIndexOrThrow(_cursor, "plantDescription");
          final int _cursorIndexOfPlantImageUrl = CursorUtil.getColumnIndexOrThrow(_cursor, "plantImageUrl");
          final int _cursorIndexOfAddedAt = CursorUtil.getColumnIndexOrThrow(_cursor, "addedAt");
          final int _cursorIndexOfLastWateredDate = CursorUtil.getColumnIndexOrThrow(_cursor, "lastWateredDate");
          final int _cursorIndexOfWateringFrequencyDays = CursorUtil.getColumnIndexOrThrow(_cursor, "wateringFrequencyDays");
          ...
          while (_cursor.moveToNext()) {
            ...
            final String _tmpPlantDescription;
            _tmpPlantDescription = _cursor.getString(_cursorIndexOfPlantDescription);
            final String _tmpPlantImageUrl;
            _tmpPlantImageUrl = _cursor.getString(_cursorIndexOfPlantImageUrl);
            ...
            final int _tmpWateringFrequencyDays;
            _tmpWateringFrequencyDays = _cursor.getInt(_cursorIndexOfWateringFrequencyDays);
            ...
            _item = new PlantelPlantEntity(_tmpId,_tmpUserId,_tmpProductId,_tmpPlantName,_tmpPlantDescription,_tmpPlantImageUrl,_tmpAddedAt,_tmpLastWateredDate,_tmpWateringFrequencyDays,_tmpNotes);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<PlantelPlantEntity> getPlantById(final int plantId) {
    final String _sql = "SELECT * FROM plantel_plants WHERE id = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, plantId);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"plantel_plants"}, new Callable<PlantelPlantEntity>() {
      @Override
      @Nullable
      public PlantelPlantEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new PlantelPlantEntity(_tmpId,_tmpUserId,_tmpProductId,_tmpPlantName,_tmpPlantDescription,_tmpPlantImageUrl,_tmpAddedAt,_tmpLastWateredDate,_tmpWateringFrequencyDays,_tmpNotes);
          } else {
            _result = null;
          }
          return _result;
  ...
  public Object getPlantByUserAndProduct(final int userId, final int productId,
    ...
    final String _sql = "SELECT * FROM plantel_plants WHERE userId = ? AND productId = ? LIMIT 1";
