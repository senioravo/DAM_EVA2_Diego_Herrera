...
public final class ProductDao_Impl implements ProductDao {
  ...
  public ProductDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfProductEntity = new EntityInsertionAdapter<ProductEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `products` (`id`,`name`,`description`,`price`,`imageUrl`,`category`,`stock`,`rating`) VALUES (?,?,?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfProductEntity = new EntityDeletionOrUpdateAdapter<ProductEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `products` SET `id` = ?,`name` = ?,`description` = ?,`price` = ?,`imageUrl` = ?,`category` = ?,`stock` = ?,`rating` = ? WHERE `id` = ?";
      }
      ...
      public List<ProductEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new ProductEntity(_tmpId,_tmpName,_tmpDescription,_tmpPrice,_tmpImageUrl,_tmpCategory,_tmpStock,_tmpRating);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<ProductEntity> getProductById(final int productId) {
      ...
      public ProductEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final float _tmpRating;
            _tmpRating = _cursor.getFloat(_cursorIndexOfRating);
            _result = new ProductEntity(_tmpId,_tmpName,_tmpDescription,_tmpPrice,_tmpImageUrl,_tmpCategory,_tmpStock,_tmpRating);
          } else {
            _result = null;
          }
          return _result;
